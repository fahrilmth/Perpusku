...
import com.frostdev.perpusku.databinding.ActivityProfileEditBinding;
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Intent data = result.getData(); //no need here as in camera case we already have image in imageurl variable
