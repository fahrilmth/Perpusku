...
import com.frostdev.perpusku.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.attacchBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pdfPickIntent();
            }
    ...
    private void validateData() {
        ...
        title = binding.titleEtpdf.getText().toString().trim();
