package com.frostdev.perpusku.helper;

import static com.frostdev.perpusku.helper.Constants.MAX_BYTES_PDF;
...
public class MyApplication extends Application {
                        ...
                        reference.child(bookId)
                                ...
                                .addOnSuccessListener(new OnSuccessListener< Void >() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(context, "Successfully deleting book", Toast.LENGTH_SHORT).show();
                                    }
                                })
    ...
    public static void loadPdfFromUrlSinglePage(String pdfUrl, String pdfTitle, PDFView pdfView, ProgressBar progressBar, TextView pagesTv) {
        ...
        ref.getBytes(MAX_BYTES_PDF)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: failed getting file url due to "+e.getMessage());
                    }
                });
    }
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl){
        ...
        Log.d(TAG_DOWNLOAD, "downloadBok: NAME"+nameWithExtension);
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Log.d(TAG_DOWNLOAD, "onDataChange: New downloads count: "+newDownloadCount);
    ...
    public static void addToFavorite(Context context, String bookId){
        ...
        if (firebaseAuth.getCurrentUser() == null){
            Toast.makeText(context, "You're not logged in, create an account!", Toast.LENGTH_SHORT).show();
        } else {
