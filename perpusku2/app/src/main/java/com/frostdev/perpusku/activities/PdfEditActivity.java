...
import com.frostdev.perpusku.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void updatePdf() {
        ...
        progressDialog.setMessage("updating back info. . .");
        progressDialog.show();
        ...
        ref.child(bookId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d(TAG, "on Success:Book updated. . . ");
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivity.this,"Book info updating. . . ", Toast.LENGTH_SHORT).show();
                    }
                })
